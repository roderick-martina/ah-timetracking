                            ...
                            <div ref={ref}
                                ...
                                >
                                    ...
                                    <div className="flex-shrink-0 flex items-center px-4">
                                        <div className={`flex flex-col font-semibold text-white uppercase`}>
                                            <p>Ah</p>
                                            <p>Timetracking</p>
                                        </div>
                                    </div>
                                    <div className={`mt-5 overflow-auto`}>
                                        <nav className="px-2 space-y-1">
                                            <InertiaLink
                                                ...
                                                className={`${route_name == 'dashboard' ? 'bg-gray-700' : ''} group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white focus:outline-none focus:bg-black-light transition ease-in-out duration-150`}
                                            ...
                                            <InertiaLink
                                                href="/time-tracking"
                                                className={`${route_name == 'time-tracking' ? 'bg-gray-700' : ''} group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white focus:outline-none focus:bg-black-light transition ease-in-out duration-150`}
                                                onClick={handleHideMobileSidebar}
                                            >
                                                {/* Heroicon name: clock */}
                                                <svg
                                    ...
                                    <nav className="px-2 space-y-1 mt-1">
                                        <InertiaLink
                                            href="/settings"
                                            className={`${route_name == 'settings' ? 'bg-gray-700' : ''} group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white focus:outline-none focus:bg-black-light transition ease-in-out duration-150`}
                                            onClick={handleHideMobileSidebar}
                                        >
                                            {/* Heroicon name: cog */}
                                            <svg
                                        ...
                                        <button
                                            className={`group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white focus:outline-none focus:bg-black-light transition ease-in-out duration-150`}
                                            onClick={logout}
                                        >
