...
return [
    ...
    */
    ...
    'not_valid'                 => ':Attribute is geen geldige waarden.',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'custom'               => [
        ...
        'rules' => [
            'teams' => [
                'role_required' => ":attribute moet klant administrator of klant medewerker zijn."
            ]
        ]
    ],
    /*
    ...
    */
    'attributes'           => [
        ...
        'role'                  => 'gebruikersgroep',
         ...
         Role::CLIENT           => 'klant administrator',
         Role::CLIENT_EMPLOYEE  => 'klant medewerker',
         TicketType::FEATURE    => 'functionaliteit',
         TicketType::TASK       => 'taak',
         TicketType::BUG        => 'bug',
         TicketType::OTHER      => 'overig',
        'project_id'            => 'project',
        'user_id'               => 'gebruiker',
        'hours_estimate'        => 'ureninschatting',
        'assignee_id'           => 'toegewezen aan',
        'type'                  => 'type',
        'billable'              => 'factureerbaar',
        'TicketComment'         => 'Comment',
        'closed'                => 'ticket status',
        'assigned_to_id'        => 'toegewezen aan',
        'status_id'             => 'status',
        'finished'              => 'voltooid',
        'open'                  => 'open',
        'closed'                => 'gesloten',
        ...
        'action'                => 'actie',
        'TicketComment'         => 'comment',
        'hours_budget'          => 'uur budget',
        'minutes_budget'        => 'minuten budget',
        'hours'                 => 'uren',
        'minutes'               => 'minuten',
        'company'               => 'bedrijf',
        'payment_date'          => 'uiterste betaaldatum',
        'quantity'              => 'aantal',
        'price_per_unit'        => 'stuksprijs',
        'concept'               => 'concept',
        'paid'                  => 'betaald',
        'paid-mollie'           => 'betaald',
        'debtor_number'         => 'debiteurnummer',
        'reminder-first'        => 'eerste',
        'reminder-second'       => 'tweede',
        'reminder-last'         => 'laatste',
        'processing'            => 'In behandeling',
        'done'                  => 'behandeld',
        'quotation_chapter_id'  => 'hoofdstuk',
